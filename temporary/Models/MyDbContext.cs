    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Customers)
                .HasForeignKey(d => d.RoleId)
                .HasConstraintName("FK__Customer__RoleId__76969D2E");
        });
        ...
        modelBuilder.Entity<MenuPermission>(entity =>
        {
            ...
            entity.HasOne(d => d.Permission).WithMany(p => p.MenuPermissions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MenuPermissions_Permissions");

            entity.HasOne(d => d.Role).WithMany(p => p.MenuPermissions)
                .HasForeignKey(d => d.RoleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_MenuPermissions_Roles");
        ...
        modelBuilder.Entity<MerchantUser>(entity =>
        {
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.MerchantUsers)
                .HasForeignKey(d => d.RoleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__MerchantU__RoleI__76619304");
        });
        ...
        modelBuilder.Entity<PaymentHistory>(entity =>
        {
            ...
            entity.Property(e => e.Ispaymentsuccess).HasColumnName("ISPAYMENTSUCCESS");
            entity.Property(e => e.Merchantid).HasColumnName("MERCHANTID");
        ...
        modelBuilder.Entity<ProviderUser>(entity =>
        {
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.ProviderUsers)
                .HasForeignKey(d => d.RoleId)
                .HasConstraintName("FK__MerchantU__RoleI__71D1E811");
        });
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasOne(d => d.Role).WithMany(p => p.Users)
                .HasForeignKey(d => d.RoleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Users__RoleID__02C769E9");
        });
        ...
        modelBuilder.Entity<UserGroupPermission>(entity =>
        {
            ...
            entity.HasOne(d => d.Permission).WithMany(p => p.UserGroupPermissions)
                .HasForeignKey(d => d.PermissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserGroup__Permi__7EF6D905");
        });
        ...
        modelBuilder.Entity<UserRolePermission>(entity =>
        {
            ...
            entity.HasOne(d => d.Permission).WithMany(p => p.UserRolePermissions)
                .HasForeignKey(d => d.PermissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserRoleP__Permi__7FEAFD3E");

            entity.HasOne(d => d.Role).WithMany(p => p.UserRolePermissions)
                .HasForeignKey(d => d.RoleId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserRoleP__RoleI__00DF2177");
        });
