 ...
 ! function() {
    ...
    function f() {
        var o, e = document.documentElement.getAttribute("data-layout"),
            ...
            t = JSON.parse(t);
        !t || "twocolumn" != e && "twocolumn" != t["data-layout"] || (document.querySelector(".navbar-menu").innerHTML = u, (o = document.createElement("ul")).innerHTML = '<a href="javascript:void(0);" class="logo"><img src="assets/images/logo-sm.png" alt="image" height="22"></a>', Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function(e) {
